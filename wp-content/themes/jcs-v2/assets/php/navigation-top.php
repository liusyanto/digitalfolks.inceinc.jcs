<nav class="navbar<?php if ( get_field ( 'fix_navigation_position' ) != 'yes' ) echo ' navbar-fixed-top'; ?>"<?php if ( get_field ( 'page_type' ) == 'fullscreen_bg' ) echo ' style="background: none;"'; ?>>
	<div class="container">
